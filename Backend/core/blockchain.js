...
/*
# Calculate new Target to keep our Block mine time under 40 seconds
# Reset Block Difficulty after every 10 Blocks
*/
const AVERAGE_BLOCK_MINE_TIME = 40;
...
class Blockchain {
  ...
  */
  ...
  Average Block Mine Time is 40 seconds 
  but you can adjust it by changing the AVERAGE_BLOCK_MINE_TIME variable 
  ==> If Block is mined in less than 40 seconds then increase the difficulty
  ==> If Block is mined in more than 40 seconds then decrease the difficulty
  */
